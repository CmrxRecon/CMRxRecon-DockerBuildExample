...
folders_path = '/media/nas/Seafile_Storage/Raw_data/MICCAIChallenge2023/ChallengeResult/Submission_MoDL/Cine/MultiCoil/Cine/ValidationSet/AccFactor10';  % 指定包含文件夹的父文件夹路径
