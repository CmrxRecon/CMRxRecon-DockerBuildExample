...
'''
path = '/media/nas/Seafile_Storage/Raw_data/MICCAIChallenge2023/ChallengeResult/Submission_MoDL/Single_Cine_08_Sax/'
...
# 存储每个人的数据到独立的文件夹中
savepath = '/media/nas/Seafile_Storage/Raw_data/MICCAIChallenge2023/ChallengeResult/Submission_MoDL/Cine/SingleCoil/ValidationSet/AccFactor'+ AccFactor
