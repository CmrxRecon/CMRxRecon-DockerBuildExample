...
'''
path = '/media/nas/Seafile_Storage/Raw_data/MICCAIChallenge2023/ChallengeResult/Submission_MoDL/Single_Mapping_04_T1/'
...
if Sub_Type == 'T1':
    pattern = r'single_rec_P(\d+)_T1map_(\d+)_(\d+)\.mat'  # 文件名的正则表达式模式
elif Sub_Type == 'T2':
...
# 存储每个人的数据到独立的文件夹中
savepath = '/media/nas/Seafile_Storage/Raw_data/MICCAIChallenge2023/ChallengeResult/Submission_MoDL/Mapping/SingleCoil/Mapping/ValidationSet/AccFactor'+ AccFactor
...
# nohup python TransDataFormat_MoDL_Single_04_T1map.py > single_04_t1map.out 2>&1 &