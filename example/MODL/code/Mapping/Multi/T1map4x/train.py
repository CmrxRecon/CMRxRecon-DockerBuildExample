...
def main(args):
    ...
    for epoch in range(start_epoch, epochs):
        for phase in phases: #['train', 'val'] or ['train']
            ...
            for i, (x, y, csm, mask, x_name) in enumerate(tqdm(dataloaders[phase])):
            ...
            logger.write('epoch {}/{} {} score: {:.6f}\tloss: {:.6f}'.format(epoch, epochs, phase, epoch_score[val_score_name], epoch_score['loss']))
    ...
    logger.write('best score: {:.6f}'.format(saver.best_score))
